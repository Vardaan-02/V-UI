      ...
      <HamburgerMenu>
        {menuItems.map((item, index) => (
          <div key={index} role="menuitem" tabIndex={0} className="group">
            <div
              className="hover:bg-gray-200 focus:bg-gray-300 dark:hover:bg-gray-800 dark:focus:bg-gray-700 focus:outline-none rounded-md px-3 py-2 transition-all cursor-pointer"
            >
              {item}
            </div>
